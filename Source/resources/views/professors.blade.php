            ...
            <nav>
                <ul class="flex space-x-6">
                    ...
                    <li><a href="/courses" class="hover:text-[#FFD700]">Cours</a></li>
                     <li><a href="/teachers" class="hover:text-[#FFD700]">Professeurs</a></li>
                    <li><a href="/quiz" class="hover:text-[#FFD700]">Quiz</a></li>
                    <li><a href="#" class="hover:text-[#FFD700]">Connexion</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main class="container mx-auto py-16 px-4">
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-700 opacity-75 mb-2">Professeur d'Anglais et de Français</p>
                <p class="text-gray-700 opacity-75 leading-relaxed">
                    Yousra est une professeure passionnée d'anglais et de français, dévouée à aider les étudiants à atteindre leurs objectifs linguistiques avec des méthodes d'enseignement innovantes.
                </p>
            </div>
